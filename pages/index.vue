<template>
  <div class="gap-6 grid px-12 py-12 lg:gap-10">
    <div class="flex flex-wrap gap-x-6 gap-y-3 items-center justify-center">
      <img class="h-12 lg:h-16" src="/public/nuxt.svg" />
      <img class="h-14 lg:h-20" src="/public/surreal.svg" />
    </div>
